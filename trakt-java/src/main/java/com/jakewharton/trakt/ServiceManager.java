...
import com.jakewharton.trakt.services.UpdateService;
...
public class ServiceManager {
    ...
    public UpdateService updateService() {
    	UpdateService service = ServiceManager.createUpdateService();
        this.setupService(service);
        return service;
    }
    ...
    public static final UpdateService createUpdateService() {
