...
{
    private final static String APP_TITLE = "Traktoid";
    private final static String APP_PNAME = "com.florianmski.tracktoid";
    ...
    public static void app_launched(Context mContext) 
    {
        ...
        {
            if (System.currentTimeMillis() >= date_firstLaunch + (DAYS_UNTIL_PROMPT * 24 * 60 * 60 * 1000) && Utils.isOnline(mContext)) 
