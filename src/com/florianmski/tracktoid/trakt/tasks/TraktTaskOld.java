...
public abstract class TraktTaskOld extends AsyncTask<Void, String, Boolean>
{
	...
	public TraktTaskOld(TraktManager tm, Fragment fragment)
	{
		this.tm = tm;
...
//				tm.onErrorTraktRequest(tListener, error);
	...
	public TraktTaskOld silent(boolean silent) 
	{
		this.silent = silent;
		return this;
	}
	...
	public TraktTaskOld silentConnectionError(boolean silentConnectionError) 
	{
